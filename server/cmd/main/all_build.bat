...
set /p tags=CGO_ENABLED=0/go:build tags: || set "tags=vweb_lib yaegi_lib gossa_lib"
...
set /p tags=CGO_ENABLED=1/go:build tags: || set "tags=vweb_lib yaegi_lib gossa_lib libsass sqlite3"
if "%tags%" == "" goto upx
set CGO_ENABLED=1

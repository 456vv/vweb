...
func Test_exitCall_Defer(t *testing.T) {
	test1 := func(a, b, c string) bool { return a == "1" }
	test2 := func(a, b string, c ...string) bool { return a == "1" }

	test3 := func(a, b string, c []string) bool { return a == "1" }
	test4 := func() bool { return true }

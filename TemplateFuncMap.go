...
var TemplateFuncMap      = map[string]interface{}{
    ...
    "Bool":builtin.Bool,
    "Int":builtin.Int,
    "_Int_": func(s []int, i ...int) []int {if s==nil && len(v)==0 {return make([]int, 0, 0)};return append(s, v...)},
    "_Int": func(i int) *int {return &i},
    "Int_": func(i *int) int {return *i},
    "SetInt": func(i *int, v int) *int {*i = v;return i},
    "Int8":builtin.Int8,
    "_Int8_": func(s []int8, i ...int8) []int8 {if s==nil && len(v)==0 {return make([]int8, 0, 0)};return append(s, v...)},
    "Int16":builtin.Int16,
    "_Int16_": func(s []int16, i ...int16) []int16 {if s==nil && len(v)==0 {return make([]int16, 0, 0)};return append(s, v...)},
    "Int32":builtin.Int32,
    "_Int32_": func(s []int32, i ...int32) []int32 {if s==nil && len(v)==0 {return make([]int32, 0, 0)};return append(s, v...)},
    "_Int32": func(i int32) *int32 {return &i},
    "Int32_": func(i *int32) int32 {return *i},
    "SetInt32": func(i *int32, v int32) *int32 {*i = v;return i},
    "Int64":builtin.Int64,
    "_Int64_": func(s []int64, i ...int64) []int64 {if s==nil && len(v)==0 {return make([]int64, 0, 0)};return append(s, v...)},
    "_Int64": func(i int64) *int64 {return &i},
    "Int64_": func(i *int64) int64 {return *i},
    "SetInt64": func(i *int64, v int64) *int64 {*i = v;return i},
    "Uint":builtin.Uint,
    "_Uint_": func(s []uint, i ...uint) []uint {if s==nil && len(v)==0 {return make([]uint, 0, 0)};return append(s, v...)},
    "_Uint": func(i uint) *uint {return &i},
    "Uint_": func(i *uint) uint {return *i},
    "SetUint": func(i *uint, v uint) *uint {*i = v;return i},
    "Uint8":builtin.Uint8,
    "_Uint8_": func(s []uint8, i ...uint8) []uint8 {if s==nil && len(v)==0 {return make([]uint8, 0, 0)};return append(s, v...)},
    "Uint16":builtin.Uint16,
    "_Uint16_": func(s []uint16, i ...uint16) []uint16 {if s==nil && len(v)==0 {return make([]uint16, 0, 0)};return append(s, v...)},
    "Uint32":builtin.Uint32,
    "_Uint32_": func(s []uint32, i ...uint32) []uint32 {if s==nil && len(v)==0 {return make([]uint32, 0, 0)};return append(s, v...)},
    ...
    "_Uint64_": func(s []uint64, i ...uint64) []uint64 {if s==nil && len(v)==0 {return make([]uint64, 0, 0)};return append(s, v...)},
    ...
    "_Float32_": func(s []float32, f ...float32) []float32 {if s==nil && len(v)==0 {return make([]float32, 0, 0)};return append(s, v...)},
    ...
    "_Float64_": func(s []float64, f ...float64) []float64 {if s==nil && len(v)==0 {return make([]float64, 0, 0)};return append(s, v...)},
    ...
    "_Complex64_": func(s []complex64, c ...complex64) []complex64 {if s==nil && len(v)==0 {return make([]complex64, 0, 0)};return append(s, v...)},
    ...
    "_Complex128_": func(s []complex128, c ...complex128) []complex128 {if s==nil && len(v)==0 {return make([]complex128, 0, 0)};return append(s, v...)},
